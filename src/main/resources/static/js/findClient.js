...
//             if (arr[i].clientName.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
//                 /*create a DIV element for each matching element:*/
//                 b = document.createElement("DIV");
//                 /*make the matching letters bold:*/
//                 b.innerHTML = "<strong>" + arr[i].clientName.substr(0, val.length) + "</strong>";
//                 b.innerHTML += arr[i].clientName.substr(val.length);
